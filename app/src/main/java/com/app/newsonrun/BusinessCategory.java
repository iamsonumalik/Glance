...
public class BusinessCategory extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menu = (Button) findViewById(R.id.bussinessviewbutton);
        share = (Button) findViewById(R.id.bussinessviewshare);
        viewPager = (ViewPager) findViewById(R.id.bussinesspager);
        buttonlayout = (RelativeLayout) findViewById(R.id.bussinessviewbuttonlayout);
        //BUtton Clicks
        ...
        try{
            SavingPublicId savingPublicId = new SavingPublicId(BusinessCategory.this);
            savingPublicId.open();
            public_idlist = savingPublicId.getByCategory("BUSINESS");
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.bussinessviewbutton:
                final Dialog dialog = new Dialog(BusinessCategory.this, android.R.style.Theme_Translucent_NoTitleBar);
                ...
                science.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        startActivity(new Intent(BusinessCategory.this,ScienceCategory.class));
                        finish();
                    }
                });
                sports.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        startActivity(new Intent(BusinessCategory.this,SportsCategory.class));
                        finish();
                    }
                });
                entertainment.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        startActivity(new Intent(BusinessCategory.this,EntertainmentCategory.class));
                        finish();
                    }
                });
                world.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        startActivity(new Intent(BusinessCategory.this,WorldCategory.class));
                        finish();
                    }
                });
                india.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        startActivity(new Intent(BusinessCategory.this,IndiaCategory.class));
                        finish();
                    }
                });
                simplified.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        startActivity(new Intent(BusinessCategory.this,SimplifiedCategory.class));
                        finish();
                    }
                });
                all.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        startActivity(new Intent(BusinessCategory.this,AllCategory.class));
                        finish();
                    }
                });
                ...
                dialog.show();
                break;
            case R.id.bussinessviewshare:
                new DownloadImageTask(BusinessCategory.this,name);
                break;
        }
    }
}
