...
public class WorldCategory extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_world_category);
        menu = (Button) findViewById(R.id.worldviewbutton);
        share = (Button) findViewById(R.id.worldviewshare);
        viewPager = (ViewPager) findViewById(R.id.worldpager);
        buttonlayout = (RelativeLayout) findViewById(R.id.worldviewbuttonlayout);
        //BUtton Clicks
        ...
        try{
            SavingPublicId savingPublicId = new SavingPublicId(WorldCategory.this);
            savingPublicId.open();
            public_idlist = savingPublicId.getByCategory("WORLD");
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.worldviewbutton:
                final Dialog dialog = new Dialog(WorldCategory.this, android.R.style.Theme_Translucent_NoTitleBar);
                ...
                india.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        startActivity(new Intent(WorldCategory.this,IndiaCategory.class));
                        finish();
                    }
                });
                simplified.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        startActivity(new Intent(WorldCategory.this,ScienceCategory.class));
                        finish();
                    }
                });
                business.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        startActivity(new Intent(WorldCategory.this,BusinessCategory.class));
                        finish();
                    }
                });
                sports.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        startActivity(new Intent(WorldCategory.this,SportsCategory.class));
                        finish();
                    }
                });
                entertainment.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        startActivity(new Intent(WorldCategory.this, EntertainmentCategory.class));
                        finish();
                    }
                });
                ...
                all.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        startActivity(new Intent(WorldCategory.this,AllCategory.class));
                        finish();
                    }
                });
                ...
                dialog.show();
                break;
            case R.id.worldviewshare:
                new DownloadImageTask(WorldCategory.this,name);
                break;
        }
    }
}
